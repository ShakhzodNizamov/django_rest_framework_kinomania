...
class Movie(models.Model):
    ...
    description = models.TextField("Описание")
    poster = models.ImageField("Постер", upload_to="kinoman/")
    year = models.PositiveSmallIntegerField("Дата выхода", default=2021)
    country = models.CharField("Страна", max_length=30)
    directors = models.ManyToManyField(Actor, verbose_name="Режиссер", related_name="film_director")
    actors = models.ManyToManyField(Actor, verbose_name="Актеры", related_name="film_actor")
    genres = models.ManyToManyField(Genre, verbose_name="жанры")
    world_premiere = models.DateField("Примиера в мире", default=date.today)
    ...
    category = models.ForeignKey(Category, verbose_name="Категоря", on_delete=models.SET_NULL, null=True)
    url = models.SlugField(max_length=160, unique=True)
...
class Rating(models.Model):
    ...
    star = models.ForeignKey(RaringStar, on_delete=models.CASCADE, verbose_name="Звезда")
